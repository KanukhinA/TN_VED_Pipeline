"""
Автотесты проверки логических пересечений правил определения класса (rule_overlap).

Сценарий интерфейса эксперта «проверка созданных правил на логические пересечения».
"""
