"""
Развёрнутые пояснения к ошибкам валидации декларации на русском (интерфейс инспектора).

Параллельно техническим errors от Pydantic формируется errors_ru для экрана проверки ДТ:
несоответствие схеме структуры признаков, межполевые правила, не назначен класс.
"""
