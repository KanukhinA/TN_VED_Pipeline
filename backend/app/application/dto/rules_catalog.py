"""
Структуры ответов REST API справочника и правил определения класса (Pydantic).

Используются интерфейсом эксперта: список справочников, проверка DSL на примере декларации,
отчёт о логических пересечениях (RuleConflictItem, RuleConflictsResponse), пакетная загрузка
эталонных описаний для семантической классификации. Без исполнения правил.
"""
