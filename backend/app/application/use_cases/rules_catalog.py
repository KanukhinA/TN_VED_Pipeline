"""
Проверка справочника на примере декларации и чтение активной версии dsl_json.

ValidateRuleUseCase — тестовая классификация и валидация Pydantic по схеме структуры признаков
(вкладка создания справочника, интерфейс эксперта). GetRuleWithActiveVersionUseCase — открытие
справочника для редактирования. Компиляция — rules.compiler.
"""
