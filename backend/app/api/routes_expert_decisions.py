"""
REST API очереди экспертизы: подтверждение имён классов и эталонов.

Задачи создают сервис генерации наименований классов, officer-пайплайн и смежные контуры;
эксперт в интерфейсе фильтрует, подтверждает или отклоняет, при согласии обновляются
эталонные примеры в справочнике. Префикс /api/v1/expert-decisions.
"""
