"""
REST API модуля создания и сохранения справочников (интерфейс эксперта → движок правил).

Реализует операции вкладки создания справочника: структура признаков и правила определения
класса в предметно-ориентированном языке (dsl_json), версионирование в PostgreSQL,
проверка на примере декларации, логические пересечения, эталоны для семантики,
калибровка порога, шаблоны и демонстрационный пример удобрений. Префикс /api/v1/rules.
"""
