"""
Фасад генерации текста: единые имена функций для сервисов пайплайна.

Маршрутизация на ollama_backend или vllm_backend по LLM_BACKEND; совместимость
с ollama_client в сервисе предобработки и сервисе генерации наименований классов.
"""
